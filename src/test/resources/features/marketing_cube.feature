...
功能: Marketing cube
  ...
  场景大纲: 点击"我知道了"
    假如 I navigate to page "<testing_url>"
    并且 I click on element having id "share_pop"
    那么 activity having title "嗨购11.11" should be present
    例子:
      | testing_url |
      | https://test.creditcard.cmbc.com.cn/index.html?encryptStr=iNCCNqr5LAp/wnVtc4XBr7FzlLS1cS/PYZaxTNn/xRln8aYryzF2RRFwVYizQThV2Q8ORNZJSA25KmjxBYpXz6r2oHMPq9ljsXH6xwik55EhLQJxx98Yq6NG5J6ksBZZ0fKN0zfWWds3+zqUOrlomvVq955QdxUCyoEvgKc7BeI= |
  ...
  场景大纲: 客户有资质
    假如 I navigate to page "<testing_url>"
    并且 activity having title "同道大叔星座卡独家伴手礼" should be present
    当 I click on activity having title "同道大叔星座卡独家伴手礼"
    那么 gift having remark "该项礼品仅可兑换一次，且不可与其他三项礼品同时选择" should be present
  ...
  场景大纲: 客户进行活动兑换
    ...
    那么 element having binding "orderMessage" should have text as "活动已下架"
